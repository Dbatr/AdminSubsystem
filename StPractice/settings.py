...
# Разрешить отправку cookies и авторизационных данных
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '0.0.0.0', 'AdninSubSystem.pythonanywhere.com']
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'adminka.permissions.IsOrganizerOrSupervisor'
    ],
